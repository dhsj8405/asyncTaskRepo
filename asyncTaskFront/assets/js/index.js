...
function getList(){
	...
	$.ajax({
        url:'http://127.0.0.1:1010/api/list.do'
        ,type:'get'
        ,data: params
        ,dataType:"json"
...
function getOne(bbsNum){
	...
	$.ajax({
        url:'http://127.0.0.1:1010/api/detail.do'
        ,type:'get'
        ,dataType: "json"
        ,data: "bbsNum="+bbsNum
        ,success:function(resp){
...
function updateOne(){
    ...
    $.ajax({
        url:"http://127.0.0.1:1010/" +(viewMode == "I" ? 'api/insert.do' : 'api/update.do')
        // ,type:'post'
		,type: 'post'
        ,dataType: "json"
        ,data: params
...
function deleteOne(bbsNum){
	$.ajax({
        url:'http://127.0.0.1:1010/api/delete.do'
        ,type:'get'
        ,dataType: "json"
        ,data: {num : bbs.num}
        ,success:function(resp){
